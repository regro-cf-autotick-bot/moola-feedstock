...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/moola-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/moola-feedstock)
...
Once the `conda-forge` channel has been enabled, `moola` can be installed with:

```
conda install moola
```

It is possible to list all of the versions of `moola` available on your platform with:
